...
urlpatterns = [
    ...
    path(
        "round-close/",
        views_round.round_close,
        name="round-close",
    ),
    path(
        "round-close/<int:round_id>/result/",
        views_round.round_close_result,
        name="round-close-result",
    ),
    path(
        "round-close/<int:round_id>/csv/",
        views_round.round_close_csv,
        name="round-close-csv",
    ),

    # 과제 관리
    path(
        "assignments/",
        views_manage.assignment_list,
    ...
    path(
        ...
        views_manage.assignment_delete,
        name="assignment-delete",
    ),
    path(
        "assignments/<int:pk>/restore/",
    ...
    path(
        "assignments/<int:pk>/submissions/remind-all/",
        views_manage.submission_remind_all,
        name="submission-remind-all",
    ),

    # 미제출 학생/팀 제출 독려
    path(
        "assignments/<int:pk>/submissions/<int:unit_id>/remind/",
        views_manage.submission_remind,
        name="submission-remind",
    ),

    # 강의 관리
    path(
        "lecture/",
        views_lecture.tutor_lecture_manage_view,
        name="lecture",
    ),
    path(
        "lecture/api/update/",
    ...
    path(
        ...
        views_review.submission_review,
    ...
    path(
    "submissions/remind-all/",
    views_manage.submission_remind_all_assignments,
    name="submission-remind-all-assignments",
    ),
]
